...
class VerifiedOtpResponseModel extends BaseResponseModel {
  Data? data;
  ...
  VerifiedOtpResponseModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Data {
  ...
  Data({this.authtoken, this.user, this.has_interest});

  Data.fromJson(Map<String, dynamic> json) {
    authtoken = json['authtoken'];
    has_interest = json['has_interest'];
